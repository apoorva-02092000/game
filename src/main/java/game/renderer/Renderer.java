...
public class Renderer{
    ...
    public Renderer() {
        ...
        this.tiles = new Tile[maxBatchSize];

        // 4 vertices quads
        vertices = new float[10 * 4 * VERTEX_SIZE];
    ...
    public void addTile(Tile tile) {
        ...
        if(!textures.contains(tile.texture)){
            textures.add(tile.texture);
        }
    ...
    private void loadVertexProperties(int index) {
        ...
        Vector4f color = new Vector4f(1, 0, 0.4f, 1);
        Vector2f[] texCoords = {
                new Vector2f(1, 1),
                new Vector2f(1, 0),
                new Vector2f(0, 0),
        ...
        for (int i=0; i < 4; i++) {
            ...
            // Load position
            vertices[offset] = tile.transform.position.x + (xAdd * tile.transform.scale.x);
            vertices[offset + 1] = tile.transform.position.y + (yAdd * tile.transform.scale.y);
